...
public class RandomNameUtil {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 100; i++){
            String chineseName = getRandomSimpleChinese(true,3);
            if (!namesSet.contains(chineseName)) {
                namesSet.add(chineseName);
            }
        }
     ...
     * @return
     */
    public static String getRandomSimpleChinese(int len) {
        String randomName = "";
        for (int i = 0; i < len; i++) {
            String str = null;
    ...
    /**
     * 生成名字
     * @param singleLastName 是否单姓
     * @param len 长度
     * @return
     */
    public static String getRandomSimpleChinese(boolean singleLastName, int len) {
        String surName[] = {
